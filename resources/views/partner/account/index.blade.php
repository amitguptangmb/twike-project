        ...
        <div class="card-body">
            <div class="tab-content" id="accountTabsContent">
                ...
                <div class="tab-pane fade show active" id="tab-info" role="tabpanel">
                    <form method="POST" action="{{ route('partner.account.update') }}" style="max-width:500px">
                        @csrf
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="tab-password" role="tabpanel">
                    <form method="POST" action="{{ route('partner.password.update') }}" autocomplete="off" id="accountChangePasswordForm" style="max-width:700px">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">
