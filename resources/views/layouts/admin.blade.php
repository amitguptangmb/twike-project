...
<head>
    ...
    <title>@yield('title', 'Admin Portal') | TWIKE</title>
    ...
    <style>
        ...
        * { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        /* Velzon-style DataTables chrome (search box, length select, pill
           ...
           else in this app. Same block on layouts/user.blade.php - keep
           both in sync. */
...
<body>
    ...
    {{-- Sidebar items match AdminMaster.Master exactly: only the links NOT
         commented out there are shown (Fund Request, Reversal, Pay Out,
         Collection, upload Reconciliation/Charge Back File are all
         commented out of the original nav too - their pages still exist
         and are routable, same as the source, just not linked here). --}}
        ...
        <ul class="nav flex-column pb-3">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.users*') ? 'active' : '' }}" href="{{ route('admin.users') }}">
                    <i class="ri-group-line"></i> <span class="nav-label">User</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.transactions*') ? 'active' : '' }}" href="{{ route('admin.transactions') }}">
                    <i class="ri-exchange-line"></i> <span class="nav-label">Transaction</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.settlements*') ? 'active' : '' }}" href="{{ route('admin.settlements') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.password.edit') ? 'active' : '' }}" href="{{ route('admin.password.edit') }}">
                    <i class="ri-lock-password-line"></i> <span class="nav-label">Change Password</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.advance-search') ? 'active' : '' }}" href="{{ route('admin.advance-search') }}">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    <a class="vz-user-btn dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        <span class="vz-avatar">A</span>
                        <span class="d-none d-sm-block">
                            <span class="d-block name">Admin</span>
                            <span class="d-block role">Administrator</span>
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('admin.password.edit') }}"><i class="ri-lock-password-line me-1"></i> Change Password</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="ri-logout-box-line me-1"></i> Logout</a></li>
                    </ul>
                </div>
            </div>
        </header>
        ...
        <main class="vz-main">
            <div class="vz-page-title">
                ...
                <nav class="vz-breadcrumb">
                    <a href="{{ route('admin.dashboard') }}">TWIKE</a> / <span class="active">@yield('title', 'Dashboard')</span>
                </nav>
            </div>
