...
<head>
    ...
    <title>@yield('title', 'User Portal') | TWIKE</title>
    ...
    <style>
        :root {
            ...
            --vz-primary: #1a1a1a;
            --vz-primary-dark: #000000;
            --vz-primary-soft: rgba(26,26,26,.1);
            --vz-body-bg: #f3f3f9;
            --vz-sidebar-bg: #1a1a1a;
        ...
        * { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .bg-theme { background: var(--vz-primary) !important; }
        .btn-theme { background: var(--vz-primary); border-color: var(--vz-primary); color: #fff; }
        .btn-theme:hover, .btn-theme:focus, .btn-theme:active { background: var(--vz-primary-dark) !important; border-color: var(--vz-primary-dark) !important; color: #fff; }
...
<body>
    ...
    {{-- Sidebar items reflect the 8 sections shown in the live "User" panel
         ...
         user.users, it's just not linked here anymore, matching what the
    ...
    <nav class="vz-sidebar">
        <a class="logo-box" href="{{ route('user.dashboard') }}">
        ...
        <ul class="nav flex-column pb-3">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('user.advance-search*') ? 'active' : '' }}" href="{{ route('user.advance-search') }}">
                    <i class="ri-search-line"></i> <span class="nav-label">Advance Search</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('user.collection') ? 'active' : '' }}" href="{{ route('user.collection') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('user.settlement*') ? 'active' : '' }}" href="{{ route('user.settlement') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('user.setting*') ? 'active' : '' }}" href="{{ route('user.setting') }}">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    <a class="vz-user-btn dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        <span class="vz-avatar">{{ strtoupper(substr(session('user.name', 'P'), 0, 1)) }}</span>
                        <span class="d-none d-sm-block">
                            <span class="d-block name">{{ session('user.name', 'User') }}</span>
                            <span class="d-block role">User</span>
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('user.account') }}"><i class="ri-user-settings-line me-1"></i> My Account</a></li>
                        <li><a class="dropdown-item" href="{{ route('user.password.edit') }}"><i class="ri-lock-password-line me-1"></i> Change Password</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="{{ route('user.logout') }}"><i class="ri-logout-box-line me-1"></i> Logout</a></li>
                    </ul>
                </div>
            </div>
        </header>
        ...
        <main class="vz-main">
            <div class="vz-page-title">
                ...
                <nav class="vz-breadcrumb">
                    <a href="{{ route('user.dashboard') }}">TWIKE</a> / <span class="active">@yield('title', 'Dashboard')</span>
                </nav>
            </div>
