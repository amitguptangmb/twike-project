...
@section('content')
    <form method="GET" action="{{ route('user.transactions') }}" class="row g-2 align-items-end mb-3">
        <div class="col-md-3">
        ...
        <div class="col-md-4 d-flex gap-2">
            ...
            <a class="btn btn-primary" href="{{ route('user.transactions.export', request()->query()) }}">Download</a>
        </div>
    </form>
