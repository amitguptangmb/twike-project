...
@section('content')
    ...
    <div class="card np-card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('user.dashboard') }}" class="row g-2 align-items-end">
                <div class="col-sm-3">
                ...
                <div class="col-sm-2">
                    <button class="btn btn-theme" type="submit"><i class="ri-search-line align-middle me-1"></i>Search</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-4 mb-4">
            <div class="card np-card h-100">
                <div class="card-header bg-theme text-white">Payin Revenue</div>
                <div class="card-body">
        ...
        <div class="col-xl-4 mb-4">
            <div class="card np-card h-100">
                <div class="card-header bg-theme text-white">Payin Volumn</div>
                <div class="card-body">
                    <table class="table mb-0">
                        <tbody>
        ...
        <div class="col-xl-4 mb-4">
            <div class="card np-card h-100">
                <div class="card-header bg-theme text-white">Payout Volumn</div>
                <div class="card-body">
                    <table class="table mb-0">
                        <tbody>
