...
/**
 * The partner-facing "Advance Search" shown in the User-panel screenshots -
 ...
 * the partner-scoped sibling of `USP_USER_PAYOUT_ADMIN` that powers the
 ...
 * page's screenshot, so it isn't ported here - a partner re-firing their
...
class AdvanceSearchController extends Controller
{
    ...
    {
        return view('partner.advance-search.index', [
            'rows' => [],
            'trFlag' => '1',
            'trans' => '',
            'utr' => '',
    ...
    public function search(Request $request)
    {
        ...
        $rows = StoredProcedure::call('USP_USER_PAYOUT', [
            ...
            '@txtUTR' => $utr === '' ? '0' : $utr,
            '@userID' => (int) $request->session()->get('partner.id'),
        ]);
