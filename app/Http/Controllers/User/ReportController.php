...
/**
 * User "Reports" page - NEW page, no ASP.NET source and no screenshot
 * exist for it anywhere in the upload (a full listing of the user/
 ...
 *   user and filters by date range in PHP. Same reconstruction, same
